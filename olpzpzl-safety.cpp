// olpzpzl-safety.exe - a safety version of olpzpzl.exe.
// Creator: VietNamLover.
// This is a safety version of olpzpzl.exe, so you can run it on your real PC.
...
DWORD WINAPI shader1(LPVOID lpParam) {
	...
	for (;;) {
		...
		for (int i = 0; i < sw * sh; i++) {
			...
			rgbtriple[i].rgbtGreen += x + i;
			rgbtriple[i].rgbtBlue += t + i;
		}
		BitBlt(desk, 0, 0, sw, sh, deskMem, 0, 0, SRCERASE);
		ReleaseDC(wnd, desk);
...
DWORD WINAPI hell1(LPVOID lpParam)
{
	...
	{
		hdc = GetDC(0);
		BitBlt(hdc, 0, 2 + rand(), x, y, hdc, 0, -2 + rand(), SRCCOPY);
		BitBlt(hdc, 0, -2 + rand(), x, y, hdc, 0, 2 + rand(), NOTSRCCOPY);
		ReleaseDC(0, hdc);
	}
}
	...
	while (1)
	{
		...
		for (int x = 0; x < screenWidth; x++)
		{
			for (int y = 0; y < screenHeight; y++)
			{
				...
				int fx = (int)((i ^ 4) + (i * 4) * cbrt(x / 20.0));
...
DWORD WINAPI textouts(LPVOID lpvd)
{
	...
	while (1)
	{
		...
		text2 = "THIS IS THE END!";
		text3 = "GOODBYE WINDOWS!";
...
DWORD WINAPI filter(LPVOID lpParam)
{
	int rr = rand() % 255;
	int gg = rand() % 255;
	int bb = rand() % 255;
...
DWORD WINAPI shader11(LPVOID lpParam) {
	...
	for (;;) {
		...
		for (int i = 0; i < sw * sh; i++) {
			int x = i % sw, y = i / sh, t = y ^ y | x;
			rgbtriple[i].rgbtRed += 100;
			rgbtriple[i].rgbtGreen += 100;
			rgbtriple[i].rgbtBlue += 100;
		}
		BitBlt(desk, 0, 0, sw, sh, deskMem, 0, 0, SRCCOPY);
		Sleep(500);
		ReleaseDC(wnd, desk);
...
// ========== MODIFIED BYTEBEATS (Similar to pankoza 2's Olthaltlzpz.exe) ==========
...
VOID WINAPI sound1() {
	...
	for (DWORD t = 0; t < sizeof(buffer); ++t)
		buffer[t] = static_cast<char>((t >> 5) & (t * 5) & (t >> 6) ^ (t >> 3) & (t + (t >> 5 & -t)) | (t >> 2));
...
VOID WINAPI sound2() {
	...
	char buffer[8000 * 30] = {};
	for (DWORD t = 0; t < sizeof(buffer); ++t)
		buffer[t] = static_cast<char>((t * 2) * ((-t >> 4) | (t >> 7)) >> (t >> 15));
	WAVEHDR header = { buffer, sizeof(buffer), 0, 0, 0, 0, 0, 0 };
	waveOutPrepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutWrite(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutUnprepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
...
VOID WINAPI sound3() {
	...
	for (DWORD t = 0; t < sizeof(buffer); ++t)
		buffer[t] = static_cast<char>(t * ((t >> 9) & 63) ^ (t >> 7));
	WAVEHDR header = { buffer, sizeof(buffer), 0, 0, 0, 0, 0, 0 };
	waveOutPrepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutWrite(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutUnprepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
...
VOID WINAPI sound4() {
	...
	for (DWORD t = 0; t < sizeof(buffer); ++t)
		buffer[t] = static_cast<char>(t * ((t & t + (t >> 14 | 2)) / ((t - 1000) ^ t) >> 5));
	WAVEHDR header = { buffer, sizeof(buffer), 0, 0, 0, 0, 0, 0 };
	waveOutPrepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutWrite(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutUnprepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
...
VOID WINAPI sound5() {
	...
	char buffer[11025 * 30] = {};
	for (DWORD t = 0; t < sizeof(buffer); ++t)
		buffer[t] = static_cast<char>(t * (((t >> 8) | (t >> 12)) & 14) & 126);
	WAVEHDR header = { buffer, sizeof(buffer), 0, 0, 0, 0, 0, 0 };
	waveOutPrepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutWrite(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutUnprepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
...
VOID WINAPI sound7() {
	...
	char buffer[8000 * 30] = {};
	for (DWORD t = 0; t < sizeof(buffer); ++t)
		buffer[t] = static_cast<char>((t * t) ^ ((t >> 11) & (t >> 7)) << 6);
	WAVEHDR header = { buffer, sizeof(buffer), 0, 0, 0, 0, 0, 0 };
	waveOutPrepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutWrite(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutUnprepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
...
VOID WINAPI sound8() {
	...
	char buffer[8000 * 30] = {};
	for (DWORD t = 0; t < sizeof(buffer); ++t)
		buffer[t] = static_cast<char>((t >> 4) & ((t >> 1) * (t >> 4)));
	WAVEHDR header = { buffer, sizeof(buffer), 0, 0, 0, 0, 0, 0 };
	waveOutPrepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutWrite(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutUnprepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
...
VOID WINAPI sound9() {
	...
	char buffer[11025 * 30] = {};
	for (DWORD t = 0; t < sizeof(buffer); ++t)
		buffer[t] = static_cast<char>(t * ((t ^ t + (t >> 14 | 1)) * ((t - 1024) ^ t) >> 9));
	WAVEHDR header = { buffer, sizeof(buffer), 0, 0, 0, 0, 0, 0 };
	waveOutPrepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutWrite(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutUnprepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
...
VOID WINAPI sound10() {
	...
	char buffer[8000 * 30] = {};
	for (DWORD t = 0; t < sizeof(buffer); ++t)
		buffer[t] = static_cast<char>((t + (t & t ^ t >> 5) + t * (t >> 8 & (t % 15 ? 3 : 5) & t >> 8)) >> 1);
	WAVEHDR header = { buffer, sizeof(buffer), 0, 0, 0, 0, 0, 0 };
	waveOutPrepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutWrite(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutUnprepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
...
VOID WINAPI sound11() {
	...
	char buffer[8000 * 30] = {};
	for (DWORD t = 0; t < sizeof(buffer); ++t)
		buffer[t] = static_cast<char>(((t | 255) * (t >> 5)) >> 1);
	WAVEHDR header = { buffer, sizeof(buffer), 0, 0, 0, 0, 0, 0 };
	waveOutPrepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutWrite(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutUnprepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
...
VOID WINAPI sound12() {
	...
	char buffer[8000 * 30] = {};
	for (DWORD t = 0; t < sizeof(buffer); ++t)
		buffer[t] = static_cast<char>(t * ((0x7B4F) >> (t >> 8 & 12) & 15) | (t >> 3));
	WAVEHDR header = { buffer, sizeof(buffer), 0, 0, 0, 0, 0, 0 };
	waveOutPrepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutWrite(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutUnprepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
...
VOID WINAPI sound13() {
	...
	char buffer[22050 * 30] = {};
	for (DWORD t = 0; t < sizeof(buffer); ++t)
		buffer[t] = static_cast<char>((t & t >> 11) | (t * (t & t >> 11)) >> 1);
	WAVEHDR header = { buffer, sizeof(buffer), 0, 0, 0, 0, 0, 0 };
	waveOutPrepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutWrite(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutUnprepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
...
VOID WINAPI sound14() {
	...
	char buffer[8000 * 30] = {};
	for (DWORD t = 0; t < sizeof(buffer); ++t)
		buffer[t] = static_cast<char>((t & t >> 11) | (t * (t & t >> 10)) >> 2);
	WAVEHDR header = { buffer, sizeof(buffer), 0, 0, 0, 0, 0, 0 };
	waveOutPrepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutWrite(hWaveOut, &header, sizeof(WAVEHDR));
	waveOutUnprepareHeader(hWaveOut, &header, sizeof(WAVEHDR));
...
{
	if (MessageBoxW(NULL, L"This is a safety version of olpzpzl.exe, run?", L"olpzpzl-safety.exe by VietNamLover", MB_YESNO | MB_ICONEXCLAMATION) == IDNO)
	{
		ExitProcess(0);
	}
	else
	{
		if (MessageBoxW(NULL, L"Are you sure? It still contains flashing lights - NOT for epilepsy", L"olpzpzl-safety.exe - Last Warning", MB_YESNO | MB_ICONEXCLAMATION) == IDNO)
		{
			ExitProcess(0);
		}
		else
		{
			...
			HANDLE thread2dot2 = CreateThread(0, 0, blur1, 0, 0, 0);
			sound2();
			Sleep(30000);
			...
			HANDLE thread8dot1 = CreateThread(0, 0, textouts, 0, 0, 0);
			sound8();
			Sleep(30000);
			...
			HANDLE thread9dot1 = CreateThread(0, 0, filter, 0, 0, 0);
			sound9();
			Sleep(30000);
