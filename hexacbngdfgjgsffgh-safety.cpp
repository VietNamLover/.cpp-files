// hexacbngdfgjgsffgh-safety.exe by VietNamLover (name by Clutter xmodz).
// This is a safety version of hexacbngdfgjgsffgh.exe, so you can run it on your real PC.
...
int CALLBACK WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    if (MessageBoxA(NULL, "This is a safety version of hexacbngdfgjgsffgh.exe, run?", "hexacbngdfgjgsffgh-safety.exe by VietNamLover (name by Clutter xmodz)", MB_YESNO | MB_ICONEXCLAMATION) == IDNO)
        ExitProcess(0);
