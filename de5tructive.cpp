// de5tructive.exe by VietNamLover.
...
int main() {
    if (MessageBoxW(NULL, L"The software you just executed is considered malware. This malware will harm your computer and makes it unusable. Are you sure to run this malware?!", L"de5tructive.exe by VietNamLover", 
    ...
    if (MessageBoxW(NULL, L"THIS IS THE LAST WARNING! THE CREATOR IS NOT RESPONSIBLE FOR ANY DAMAGE MADE USING THIS MALWARE, STILL EXECUTE IT?! ", 
                    L"de5tructive.exe", MB_YESNO | MB_ICONEXCLAMATION) == IDNO) {
        ExitProcess(0);
    }
